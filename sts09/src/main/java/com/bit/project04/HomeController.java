...
import com.bit.project04.model.EmpDao;
...
//		model.addAttribute("list", obj.selectAll());
	...
	public String add(EmpVo bean) throws SQLException {
		EmpDao obj = sqlSession.getMapper(EmpDao.class);
		obj.insertOne(bean);
	...
	public String edit(EmpVo bean) throws SQLException {
		EmpDao obj=sqlSession.getMapper(EmpDao.class);
		obj.updateOne(bean);
	...
	public View delete(int sabun) throws SQLException {
